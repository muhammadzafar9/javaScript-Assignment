      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.topSection}>
          ...
          <View style={styles.deviceInfo}>
            <View style={styles.deviceCard}>
              <Text style={styles.deviceTitle}>Roku Smart TV</Text>
        ...
        <View style={styles.remoteContainer}>
          ...
          <View style={styles.streamingRow}>
            <TouchableOpacity 
              style={[styles.streamingButton, styles.button, { backgroundColor: '#E50914' }]}
            ...
            <TouchableOpacity 
              style={[styles.streamingButton, styles.button, { backgroundColor: '#FF0000' }]}
            ...
            <TouchableOpacity 
              style={[styles.streamingButton, styles.button, { backgroundColor: '#00A8E1' }]}
